...
const TermsAndConditions = () => {
  return (
    <motion.div
      ...
      className="max-w-4xl mx-auto w-11/12 py-10"
    >
      <Card className="bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 text-white rounded-2xl shadow-xl">
        <CardHeader>
          <CardTitle className="text-4xl font-extrabold flex items-center gap-2">
            <Gavel className="h-7 w-7" /> Terms & Conditions
          </CardTitle>
        ...
        <CardContent className="space-y-4 leading-relaxed">
          ...
          <h3 className="text-xl font-semibold">6. Changes</h3>
          <p>
