...
const PrivacyPolicy = () => {
  return (
    ...
    >
      <Card className="bg-gradient-to-br from-fuchsia-500 via-rose-500 to-orange-500 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 text-white rounded-2xl shadow-xl">
        <CardHeader>
          <CardTitle className="text-4xl font-extrabold flex items-center gap-2">
            <Shield className="h-7 w-7" /> Privacy Policy
          </CardTitle>
